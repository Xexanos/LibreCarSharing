...
public class RestApi {
    ...
    public Response getAllCarsFromCommunity(@PathParam("comid") final long comId) {
        ...
        if (community != null) {
            if (subject != null && subject.getPrincipal() != null) {
                if ((community.getUsers().stream().map(DBUser::getUsername).collect(Collectors.toList())
    ...
    public Response getAllcommunitiesFromUser(@PathParam("userid") final long userId) {
        ...
        if (user != null) {
            if (subject != null && (subject.getPrincipal() != null && (subject.getPrincipal().equals(user.getUsername())) || subject.hasRole("admin"))) {
                final CriteriaBuilder builder = this.entityManager.getCriteriaBuilder();
        ...
        if (subject.getPrincipal() != null) {
            ...
            if (principal != null) {
                ...
                if (rides.size() == 1) {
                    ...
                    System.out.println(ride.getCreator().getId());
                    ...
                    if (ride.getCreator().getId() == subid) {
